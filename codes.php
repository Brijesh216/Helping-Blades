...
<html>
<head>
<title>Big store a Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template </title>
<!-- for-mobile-apps -->
...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="index.php"></b>Helping Blades<span>The Best Supermarket</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
