...
<link href='//fonts.googleapis.com/css?family=Vazirmatn:400,700' rel='stylesheet' type='text/css'>
...
<body>
<a href="offer.php"><img src="images/downloadpng" class="img-head" alt=""></a>
<div class="header">

		<div class="container">
			
			<div class="logo">
				<h1><a href="index.php">  Helping Blades  <!--<span>The Best Supermarket</span>-->
			</a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
